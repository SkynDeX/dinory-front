...
// 선택 스타일별 인사이트
function getChoiceInsight(choiceName) {
    const insights = {
        '용감한 선택': '아이가 도전을 두려워하지 않고 용기 있게 행동하는 경향이 있어요.',
        '배려하는 선택': '다른 사람의 감정을 잘 헤아리고 배려하는 마음이 있어요.',
        '협력하는 선택': '친구들과 함께하는 것을 좋아하고 협동을 중요하게 생각해요.',
        '신중한 선택': '상황을 잘 관찰하고 신중하게 판단하는 능력이 있어요.',
        '자신있는 선택': '자기 자신을 믿고 당당하게 행동하는 모습을 보여요.',
        '도전적인 선택': '새로운 것에 도전하는 것을 즐기고 모험을 좋아해요.'
    };
    return insights[choiceName] || '아이만의 특별한 선택 스타일을 보여주고 있어요.';
}
